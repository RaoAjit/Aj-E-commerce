...
def customerregistration(request):
  ...
  if request.method == 'POST':
   ...
   if fm.is_valid():
    ...
    ajit='i am meawoo'
    fm.save()
    return render(request,'app/customerregistration.html',{'forms':fm,'ajit':ajit}) 
  return render(request,'app/customerregistration.html',{'forms':fm})
...
def laptop(request):
 return render(request,'app/botstrap.html')